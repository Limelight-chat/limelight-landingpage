...
const browserCollections = {
  blogPosts: create.doc("blogPosts", {"AI-J-Curve.mdx": () => import("../content/blog/AI-J-Curve.mdx?collection=blogPosts"), "Minimalist-UI.mdx": () => import("../content/blog/Minimalist-UI.mdx?collection=blogPosts"), "design-philosophy.mdx": () => import("../content/blog/design-philosophy.mdx?collection=blogPosts"), "getting-started.mdx": () => import("../content/blog/getting-started.mdx?collection=blogPosts"), "limelight-launch.mdx": () => import("../content/blog/limelight-launch.mdx?collection=blogPosts"), }),
