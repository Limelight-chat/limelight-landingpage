...
const browserCollections = {
  blogPosts: create.doc("blogPosts", {"AI-J-Curve.mdx": () => import("../content/blog/AI-J-Curve.mdx?collection=blogPosts"), "limelight-launch.mdx": () => import("../content/blog/limelight-launch.mdx?collection=blogPosts"), "most-business-data-is-messy.mdx": () => import("../content/blog/most-business-data-is-messy.mdx?collection=blogPosts"), "what-analysts-actually-do-all-day.mdx": () => import("../content/blog/what-analysts-actually-do-all-day.mdx?collection=blogPosts"), }),
