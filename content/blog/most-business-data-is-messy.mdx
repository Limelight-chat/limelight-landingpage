...
4.  **Duplicate Entity Detection**: The engine flagged repeated values like "Baker and Sons" to help users determine whether duplicates represent expected data or underlying data quality issues.
