...
// TODO: Replace with your own report issue dialog component
    ...
    <footer className="w-full bg-[#0A0A0A] border-t border-white/10 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-20 flex flex-col items-center">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-4 md:gap-6">
          ...
          /> */}
          <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-32 lg:h-32 bg-orange-500 rounded-lg"></div>
