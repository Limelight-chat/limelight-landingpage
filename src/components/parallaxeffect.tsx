...
const ICONS = [
  {
    src: projectTools,
    alt: "Project Tools",
    pos: "-top-[12%] -left-[10%] lg:top-[2%] lg:left-[10%] 2xl:top-[3%] 2xl:left-[18%]",
    size: "w-42 h-42 lg:w-76 lg:h-76 2xl:w-78 2xl:h-78",
  },
  {
    src: youtube,
    alt: "youtube",
    pos: "-bottom-[8%] left-[12%] lg:bottom-[4%] lg:left-[34%] 2xl:bottom-[2%] 2xl:left-[44%]",
    size: "w-10 h-10 lg:w-14 lg:h-14 2xl:w-16 2xl:h-16",
  },
  {
    src: drive,
    alt: "Drive",
    pos: "top-[2%] left-[30%] lg:top-[25%] lg:left-[34%] 2xl:top-[20%] 2xl:left-[38%]",
    size: "w-12 h-12 lg:w-20 lg:h-20 2xl:w-18 2xl:h-18",
  },
  {
    src: local,
    alt: "local files",
    pos: "top-[78%] left-[4%] lg:top-[50%] lg:left-[16%] 2xl:top-[50%] 2xl:left-[26%]",
    size: "w-48 h-48 lg:w-84 lg:h-84 2xl:w-92 2xl:h-92",
  },
  {
    src: excel,
    alt: "Excel",
    pos: "top-[20%] right-[13%] lg:top-[20%] lg:right-[44%] 2xl:top-[12%] 2xl:right-[44%]",
  ...
  },
  {
    src: crm,
    alt: "CRM",
    pos: "-top-[15%] right-[2%] lg:-top-[7%] lg:right-[14%] 2xl:-top-[8%] 2xl:right-[20%]",
    size: "w-48 h-48 lg:w-82 lg:h-82 2xl:w-92 2xl:h-92",
  },
  {
    src: chat,
    alt: "Chat Tools",
    pos: "-bottom-[6%] left-[46%] lg:-bottom-[1%] lg:left-[59%] 2xl:-bottom-[1%] 2xl:left-[59%]",
    size: "w-48 h-48 lg:w-82 lg:h-82 2xl:w-84 2xl:h-84",
  },
  {
    src: dropbox,
    alt: "Dropbox",
    pos: "bottom-[12%] right-[65%] lg:bottom-[20%] lg:right-[48%] 2xl:bottom-[0%] 2xl:right-[39%]",
    size: "w-9 h-9 lg:h-20 lg:w-20 2xl:w-18 2xl:h-18",
  },
  {
    src: shopify,
    alt: "Shopify",
    pos: "top-[70%] left-[5%] lg:top-[10%] lg:left-[42%] 2xl:top-[2%] 2xl:left-[44%]",
    size: "w-12 h-12 lg:h-16 lg:w-16 2xl:w-18 2xl:h-18",
  },
];
